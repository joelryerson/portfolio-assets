...
const buttons = document.querySelectorAll('.button, .icon-button, .chip, .button-segment, .accordion-header, .menu-item, .nav-rail-segment, .navbar-mobile-segment, .fab');
...
document.addEventListener("DOMContentLoaded", function () {
    const buttons = document.querySelectorAll('.button, .icon-button, .chip, .button-segment, .accordion-header, .menu-item, .nav-rail-segment, .nav-rail-segment.w--current, .navbar-mobile-segment, .fab');
